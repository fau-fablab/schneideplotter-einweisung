...
\begin{itemize}
 \item Papier bis 250 g/m² \todo{oder mehr ?}  (Achtung, 80g Papier reißt oft beim Ablösen von der Schneideunterlage!)
 \item Overheadfolie
 \item \todo{was noch?}
\end{itemize}
...
Das Material wird darauf gelegt \todo{Details dazu erklären}
...
\node[erklaerungstext] (zutief) at (-13,-3.5) {zu tief: Trägermaterial kann durchschnitten werden};
...
\node[erklaerungstext] (zutief) at (-13,-3) {zu tief: Trägermaterial wird deutlich angeschnitten};
\node[erklaerungstext] (okay) at (-13,-2) {richtig: Träger wird nur leicht angeritzt};
\node[erklaerungstext] (zuhoch) at (-13,-1) {zu hoch: Folie wird nicht durchschnitten};
\draw[->]  (zuhoch.east) to (-4,-1.8);
