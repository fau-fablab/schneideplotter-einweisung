...
Einstellen: \plotterMenu mehrmals drücken bis \plotterDisplay{UNSETUP} erscheint. Einmal \plotterPfeilRunter drücken damit \plotterDisplay{FORCE} erscheint und mit \plotterPfeilRechts bestätigen. Dann so oft \plotterPfeilRunter drücken bis \plotterDisplay{SPEED} erscheint und mit \plotterPfeilRechts bestätigen. Mit \plotterPfeilRauf/\plotterPfeilRunter den Wert auswählen. Mit \plotterEnter bestätigen. Am Ende auf \plotterMenu drücken.
...
Der Plotter kann spezielle Druckmarken erkennen und so genau passend zur ausgedruckten Seite ausschneiden. So kann man bunte Aufkleber mit beliebigen Formen herstellen.
...
\item Wichtiger Hinweis zum Bedrucken mit dem FabLab-Laserdrucker Lexmark CS725:
    \begin{itemize}
    \item Papier in den manuellen Einzug einlegen (wenn dieser eingeklappt ist, über den "Schiebe-Knopf" ausklappen)
...
\item Plotterkopf mit den Pfeiltasten nach ganz links unten bewegen.
\item In Cutstudio: Datei - Schneiden.
\item Am Ende in Cutstudio die Einstellung \enquote{Datei - Drucken und schneiden} wieder ausschalten, weil sich Cutstudio diese Einstellung merkt und das die nächsten Benutzer verwirrt.
