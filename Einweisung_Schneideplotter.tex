...
\newcommand{\knopf}[2]{
    \begin{tikzpicture}[baseline={(box.base)}, fragile]
    \node [#1] (box) { 
...
Danach ziehst Du von einer Seite ein Stück des Trägermaterials im \SI{\deg{180}}-Winkel ab, und bringst diesen Teil des Aufklebers durch Anrubbeln an.
Das Application Tape wird noch nicht entfernt.
Du kannst jetzt langsam weitere Teile des Trägermatierals abziehen (\SI{\deg{180}}-Winkel!) und anrubbeln,
...
Abschließend wird das Application Tape vorsichtig im \SI{\deg{180}}-Winkel abgezogen, und danach der gesamte Aufkleber noch ein letzes mal mit der Rakel angedrückt.
...
Du kannst danach das Trägermaterial abziehen (\SI{\deg{180}}-Winkel!) und den Aufkleber samt Application Tape auf dem Untergrund aufbringen.
...
Nachdem der Aufkleber getrocknet ist, drückst Du ihn mit der Rakel gründlich an, und kannst danach das Application Tape im \SI{\deg{180}}-Winkel abziehen.
